...
const api: KlennyApi = {
  ...
  extractDocument: (request) => ipcRenderer.invoke(IPC.extractDocument, request),
  ...
  compactMemory: (scope) => ipcRenderer.invoke(IPC.memoryCompact, scope),
  ...
  listPawprints: () => ipcRenderer.invoke(IPC.pawprintList),
