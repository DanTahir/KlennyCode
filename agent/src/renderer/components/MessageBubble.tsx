          ...
          <div className="text-xs font-medium text-amber-300 mb-2">
            {message.noteKind === 'truncation'
              ...
              : message.noteKind === 'compaction_resume'
                ...
                : message.noteKind === 'audit_resume'
                  ? `⏵ Task resumed after audit — automatic continuation notice (generated by ${brandName}, not by you)`
